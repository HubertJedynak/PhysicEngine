...
public class zzz9bKolizjeBryl extends Application {
    Group group;
    Camera camera;
    Scene scene;
...
//                Point3D[] punkty = Collisions.ChainsJointBallInJoint.serveCollision(c2,c1);
                ...
                //Point3D[] punkty = Collisions.Chains2BallsEngines.serveCollision(c1, c2, ej1, sj2);
                Point3D[] punkty = CollisionsOld.Chains2BallsEnginesBezOsobliwosci.serveCollision(c1, c2, ej1, sj2);
