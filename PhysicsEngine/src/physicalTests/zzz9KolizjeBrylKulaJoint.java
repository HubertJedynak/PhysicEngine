...
public class zzz9KolizjeBrylKulaJoint extends Application {
    Group group;
    Camera camera;
    Scene scene;
...
//        Ball ej1 = new Ball(20, -10, -10, 3, 3.5);
        Ball sj1a = new Ball(25, 7, 0, 3, 3.5);
        Ball sj1b = new Ball(25, 3, 0, 3, 3.5);
        Ball ej1 = new Ball(15, 5, 0, 3, 3.5);
...
//                Point3D[] punkty = Collisions.ChainsJointBallInJoint.serveCollision(c2,c1);
                Point3D[] punkty = CollisionsOld.ChainsJointBallInJoint.serveCollision(c1,c2,ej1,j2);
...
//                    System.out.println("W2 "+c2.W.magnitude());
                    ...
                    System.out.println("stosunek energii " + (Ekprzed / Ekpo));
