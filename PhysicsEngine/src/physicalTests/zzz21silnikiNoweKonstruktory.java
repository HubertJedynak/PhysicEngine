...
public class zzz21silnikiNoweKonstruktory extends Application {
    Group group;
    Camera camera;
    Scene scene;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Joint jSilnik1b = new Joint(sj1, bSilnik1b, 2, true);
        Joint jSilnik2b = new Joint(sj2, bSilnik2b, 2, true);
        ...
        //ch = new Chwytak(c, bChwytak, sj1, jChwytak, chainsList);
        ch2 = new Gripper(c, bChwytak, sj1, jChwytak, chainsList);
...
//        sp1 = new SilnikPrzesuwnyBezExtends(je1, ej1, bEngine1, new ArrayList<>(jointList1), new ArrayList<>(jointList2), c, 0.5);

        sp1 = new LinearMotor(je1, c, 0.5);
...
//        jointList2.add(jSilnik2b);
        ...
        //so1 = new SilnikObrotowyBezExtends(bEngine1, je1, je, ej1, bEngine2, new ArrayList<>(jointList1), new ArrayList<>(jointList2), c, 0.01);
        so1 = new RotaryMotor(bEngine1, je1, je, c, 0.01);
...
//        Ball eTest = new Ball(-25,-7,-10,2,5);
        ...
        Joint jTest = new Joint(sTest, eTest, 2, true);
        group.getChildren().addAll(sTest, eTest, jTest);

        Chain cTest = new Chain(jTest);
        chainsList.add(cTest);

//        jTest.isCollisionDetectable = false;
//        sTest.isCollisionDetectable = false;
//        eTest.isCollisionDetectable = false;
