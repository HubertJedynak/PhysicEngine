...
public class zzz11SilnikPrzesuwny2 extends Application {
    Group group;
    Camera camera;
    Scene scene;
    ...
    // do odbijania pilek
    double g = 0.001;
    SilnikPrzesuwnyStary sp13,sp23;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Ball sj1 = new Ball(-20, -20, 0, 3, 500);
        Ball ej1 = new Ball(-20, 0, 0, 3, 500);
...
//        Joint j4 = new Joint(ej3, ej2, 2);
//        group.getChildren().addAll(j4);


        Chain c = new Chain(j1, j2, j3);
...
//        group.getChildren().add(sp);
        ...
        sp13 = new SilnikPrzesuwnyStary(c, ballList1, ej1, ballList23, ej3, 2, 0.1);
        group.getChildren().add(sp13);

        sp23 = new SilnikPrzesuwnyStary(c, ballList2, ej2, ballList13, ej3, 2, 0.1);
